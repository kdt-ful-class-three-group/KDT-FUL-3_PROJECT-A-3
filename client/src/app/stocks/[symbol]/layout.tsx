...
export default function StocksLayout({ children }: { children: React.ReactNode }) {
    ...
    //가이드 자동 실행
    useEffect(()=>{
        const isStockPage = pathname==='/stocks'|| /^\/stocks\/[^/]+$/.test(pathname)
        ...
        <div className="w-full flex justify-center">
            <div className="w-full max-w-[420px] px-4 flex flex-col">
                ...
                <div className="flex justify-between items-center py-4">
                    ...
                    <Button name="가이드라인" className="w-37 h-10 bg-[#B0DB9C] rounded-lg text-white cursor-pointer" onClick={handleChartGuide} />
                </div>
